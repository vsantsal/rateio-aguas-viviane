          ...
          {rateio && (
            <>
              <section className="grid sm:grid-cols-4 gap-3 mb-6">
                ...
                <Summary label="Soma das leituras" value={`${fmtNum(rateio.totalConsumido)} m³`} />
                <Summary
                  label="Diferença (faturado − medido)"
                  value={`${rateio.diferenca >= 0 ? "+" : ""}${fmtNum(rateio.diferenca)} m³`}
                  hint={rateio.diferenca !== 0 ? "Vazamento, hidrômetro geral ou perdas." : undefined}
                />
              </section>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      ...
                      <tr className="border-t-2 border-border bg-surface/60 font-semibold">
                        <Td>Total</Td>
                        <Td className="text-right">{fmtNum(rateio.totalConsumido)}</Td>
